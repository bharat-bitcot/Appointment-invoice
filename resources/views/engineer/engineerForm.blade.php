    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6 jumbotron">
                <h1 class="text-center"> Register Service Engineer </h1><br>
                ...
                {!! Form::open(['route'=>['save.serviceEngineer'], 'method' => 'POST', 'class'=> 'form-horizontal registerForm', 'id'=>'registerForm' ]) !!}
                    {!! Form::token() !!}
                    @csrf
